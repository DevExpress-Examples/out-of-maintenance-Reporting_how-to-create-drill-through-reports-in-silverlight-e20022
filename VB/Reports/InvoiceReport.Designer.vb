...
Namespace Reports
	Partial Public Class InvoiceReport
		...
		Private Sub InitializeComponent()
			...
			' lbBillTo
			' 
			Me.lbBillTo.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(212))))), (CInt(Fix((CByte(212))))), (CInt(Fix((CByte(212))))))
			...
			' xrTableRow1
			' 
			Me.xrTableRow1.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(255))))), (CInt(Fix((CByte(167))))), (CInt(Fix((CByte(73))))))
			...
			' xrTableRow2
			' 
			Me.xrTableRow2.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(238))))), (CInt(Fix((CByte(238))))), (CInt(Fix((CByte(238))))))
			...
			' clSubtotal
			' 
			Me.clSubtotal.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(212))))), (CInt(Fix((CByte(212))))), (CInt(Fix((CByte(212))))))
			...
			' xrTableRow4
			' 
			Me.xrTableRow4.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(255))))), (CInt(Fix((CByte(167))))), (CInt(Fix((CByte(73))))))
			...
			' xrTableRow5
			' 
			Me.xrTableRow5.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(238))))), (CInt(Fix((CByte(238))))), (CInt(Fix((CByte(238))))))
			...
			' clFreight
			' 
			Me.clFreight.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(212))))), (CInt(Fix((CByte(212))))), (CInt(Fix((CByte(212))))))
			...
			' lbShipTo
			' 
			Me.lbShipTo.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(212))))), (CInt(Fix((CByte(212))))), (CInt(Fix((CByte(212))))))
			...
			' DataStyleOdd
			' 
			Me.DataStyleOdd.BackColor = System.Drawing.Color.FromArgb((CInt(Fix((CByte(255))))), (CInt(Fix((CByte(244))))), (CInt(Fix((CByte(188))))))
